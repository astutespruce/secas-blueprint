...
<section class={cn('py-6 pl-4 pr-8 overflow-y-auto h-full', className)}>
	...
	<p class="text-lg leading-snug">
		...
		improve the Southeast Blueprint Explorer interface. Southeast Blueprint staff will read and
	...
	<p class="text-lg leading-snug">
		...
		proposal or inform a decision? Southeast Blueprint staff are here to support you! We really mean
		it. It is what we do!
		<br />
		<br />
		Please reach out to
