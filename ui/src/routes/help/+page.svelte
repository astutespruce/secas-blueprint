...
<div class="container text-lg pt-4 pb-16 [&_img]:border [&_img]:border-grey-2">
	...
	<div class="mt-16 grid grid-cols-0 md:grid-cols-[1fr_1.5fr] gap-8">
		...
		<div class="flex flex-col justify-center">
			<p>
				Use the tabs in the sidebar to navigate the different types of summary information available
	...
	<p class="mt-2">
		This mode allows you to show values at a specific point for the Blueprint, indicators, threats,
	...
	<p class="mt-2">
		Filters can help you find the part of the Blueprint that aligns with your mission, interests, or
		specific question. Use the filters to show areas on the map that fall within a range of values
		for one or more layers, including the Blueprint, hubs and corridors, underlying indicators, and
		threats.
	</p>
	...
	<div class="grid grid-cols-2 gap-8 mt-16">
		<div class="flex flex-col justify-center">
			<p>
				...
				<br />
				<br />
				Click the checkbox for a given layer to enable it for filtering the map. Use the next level of
				checkboxes to select the specific values that you want to display.
			</p>
		</div>
		<div>
	...
	<p class="mt-16">
		You can select more than one layer. The filters are evaluated using AND logic, which means that
		in order for a pixel to display on the map, it must meet all the selected criteria. If you
		filter by layers that do not co-occur at the same location, such as estuarine coastal condition
	...
	<p class="mt-8">
		Note: pixel filters may take a few moments to display within your browser, especially as you pan
		or zoom the map. You may need to zoom in to see areas that meet your filters.
	</p>
	...
	<div class="grid grid-cols-3 gap-8 mt-16">
		<div class="flex flex-col justify-center">
			<p>
				...
				<br />
				<br />
				Once you have selected a location from the list of results, or clicked the <b>Go</b> button for
				latitude and longitude, it will show a marker at that location on the map.
			</p>
		</div>
		<div>
			<enhanced:img
