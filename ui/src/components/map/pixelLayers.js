...
export const pixelLayers = [
  ...
  },
  {
    ...
    encoding: [
      ...
      { id: 'base:land_saforestbirds', offset: 4, bits: 3, valueShift: 1 },
      {
      ...
      { id: 'base:marine_samarinebirds', offset: 14, bits: 3, valueShift: 0 },
      { id: 'base:marine_samammals', offset: 17, bits: 3, valueShift: 0 },
      {
